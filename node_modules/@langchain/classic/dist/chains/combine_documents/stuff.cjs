...
*/
async function createStuffDocumentsChain({ llm, prompt, outputParser = new _langchain_core_output_parsers.StringOutputParser(), documentPrompt = require_base.DEFAULT_DOCUMENT_PROMPT, documentSeparator = require_base.DEFAULT_DOCUMENT_SEPARATOR }) {
